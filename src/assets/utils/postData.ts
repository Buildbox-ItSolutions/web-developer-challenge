...
export const postData = [
  {
    ...
    texto:
      ...
      "\n\n💼 Recentemente, assisti a um vídeo da Nathalia Arcuri sobre uma técnica de organização" +
      " voltada para quem busca uma recolocação no mercado de trabalho. A ideia é simples e direta ao ponto: " +
      "tornar 12 horas do seu dia o mais produtivas possíveis, distribuindo as atividades de maneira " +
      "estratégica para impulsionar sua busca por emprego." +
      "\n\n💡 Bem, como programador, essas ideias sempre acabam virando projetos, " +
      "e agora, nesse momento que estou desempregado e procurando aumentar minha produtividade, acabei me " +
      "deparando com a Técnica das 12 Horas!  \n\nComo um bom Dev resolvi fazer uma plataforma para melhor " +
      "organizar minha produtividade. Ficou curioso sobre do que se trata a tecnica das 12 horas? Como está a plataforma e afins? " +
      "Da uma olhada na demo (Ainda em construção) e no meu Github!🌟 \n\n" +
      `Link da Demo: https://tecnica12horas.netlify.app/ \n` +
      `Link do Github: https://github.com/Felipe-alv-es/TwelveHoursProject \n\n` +
