  ...
  return (
    <article className="flex w-full flex-col rounded-sm border border-gray-300 dark:border-greyish-brown-two dark:bg-[#313131]">
      ...
      <div className="flex h-full flex-col gap-4 p-4 pt-0 md:flex-row md:gap-8 md:p-6 md:pb-8 md:pt-3">
        <div className="flex h-14 w-full items-center justify-center rounded-[36px] border-gray-300 text-black-two md:h-[88px] md:w-[88px] md:border dark:border-greyish-brown-three dark:text-zinc-400">
          {!post.user.photo ? (
        ...
        <div className="flex w-[348px] flex-col gap-4 md:gap-6">
          <p className="w-full text-black-two dark:text-warm-grey-three">{post.text}</p>
          <div className="flex flex-col gap-[2px]">
            <em className="text-xs font-medium not-italic text-warm-grey-three dark:text-brownish-grey">Enviado por</em>
